...
invalid username
```
with this, we can enumerate for valid users using hydra command
```
...
with the shell captured, read the content of "/home/robot/password.raw-md5" and crack robots password with crackstation or use john

Su as john and get the key at '/home/robot/key-2-of-3.txt'
